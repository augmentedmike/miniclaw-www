      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="flex justify-center">
          <a
            ...
            className="group relative flex flex-col items-center gap-5 rounded-3xl border border-border/40 bg-card p-10 text-center transition-all hover:border-pink-500/50 hover:shadow-xl hover:shadow-pink-500/10 hover:-translate-y-1 max-w-sm"
          >
