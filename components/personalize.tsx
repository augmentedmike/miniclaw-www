      ...
      {pickerOpen && (
        ...
        >
          ...
          >
            ...
            <p className="mb-1 text-sm font-medium uppercase tracking-widest text-primary">{t('chooseAgent')}</p>
            <p className="mb-6 text-xs text-white/40">{t('pickOrBring')}</p>
            ...
            <div className="grid grid-cols-4 gap-4 sm:grid-cols-5">
              ...
              >
                ...
                <span className="mt-2 text-xs text-white/40 group-hover:text-white/80">{t('custom')}</span>
              </button>
            </div>
          </div>
        </div>
